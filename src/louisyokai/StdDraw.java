package louisyokai;
/******************************************************************************
 *  Compilation:  javac louisyokai.StdDraw.java
 *  Execution:    java louisyokai.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code louisyokai.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code louisyokai.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">louisyokai.StdDraw.java</a>
 ...
 *           louisyokai.StdDraw.setPenRadius(0.05);
 *           louisyokai.StdDraw.setPenColor(louisyokai.StdDraw.BLUE);
 *           louisyokai.StdDraw.point(0.5, 0.5);
 *           louisyokai.StdDraw.setPenColor(louisyokai.StdDraw.MAGENTA);
 *           louisyokai.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code louisyokai.StdDraw.line()} and {@code louisyokai.StdDraw.point()}
 *  draw lines and points; the methods {@code louisyokai.StdDraw.setPenRadius()}
 *  and {@code louisyokai.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code louisyokai.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   louisyokai.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code louisyokai.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code louisyokai.StdDraw.setPenColor(louisyokai.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code louisyokai.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code louisyokai.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   louisyokai.StdDraw.setFont(font);
 *   louisyokai.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code louisyokai.StdDraw.clear(louisyokai.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   louisyokai.StdDraw.setScale(-2, +2);
 *   louisyokai.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       louisyokai.StdDraw.clear();
 *       louisyokai.StdDraw.filledCircle(x, y, 0.05);
 *       louisyokai.StdDraw.filledCircle(-x, -y, 0.05);
 *       louisyokai.StdDraw.show();
 *       louisyokai.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code louisyokai.StdDraw.BLACK}, {@code louisyokai.StdDraw.BLUE}, {@code louisyokai.StdDraw.CYAN},
     * {@code louisyokai.StdDraw.DARK_GRAY}, {@code louisyokai.StdDraw.GRAY}, {@code louisyokai.StdDraw.GREEN},
     * {@code louisyokai.StdDraw.LIGHT_GRAY}, {@code louisyokai.StdDraw.MAGENTA}, {@code louisyokai.StdDraw.ORANGE},
     * {@code louisyokai.StdDraw.PINK}, {@code louisyokai.StdDraw.RED}, {@code louisyokai.StdDraw.WHITE}, and
     * {@code louisyokai.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to louisyokai.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to louisyokai.StdDraw)
        try {
            URL url = louisyokai.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
